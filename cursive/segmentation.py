...
#            print area
            if area > 10000:
                ...
                cv.imwrite("cursive/result/words/" + str(counter) +".jpg",letterBgr)
                counter=counter+1
        cl=cl+1
...
# In[Visualize]:
##*******************************************************************************###
def visualize(letterGray, letter2, upper_baseline, lower_baseline, colcnt, min_pixel_threshold, min_separation_threshold, min_round_letter_threshold, h):
    seg = []
    seg1 = []
    seg2 = []
...
def segmentation(img):
    try:
        ...
        img2 = cv.imread('cursive/sample_images/c.png')
#        path='./result/'
    ...
    ###------------------------Visualize segmentation------------------------------#####        
            ...
            seg = visualize(letterGray, letter2, upper_baseline, lower_baseline, colcnt, min_pixel_threshold, min_separation_threshold, min_round_letter_threshold, h)
            wordImgList = segmentCharacters(seg,letterGray)
            for i in wordImgList:
                cv.imwrite("cursive/result/characters/" + str(counter) +".jpeg",i)
                counter=counter+1
